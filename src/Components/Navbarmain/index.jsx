  ...
  return (
    <nav className="main-nav">
      ...
      <NavUnlisted>
        ...
        <NavLink to="/search-note" className={({ isActive }) =>
              isActive ? activeClassName : undefined
            }>
          <li className="hover-line">Notes</li>
        </NavLink>
        <NavLink to="/new-note" className={({ isActive }) =>
              isActive ? activeClassName : undefined
            }>
          <li className="hover-line">Create</li>
        </NavLink>
        <NavLink to="/upload-note" className={({ isActive }) =>
              isActive ? activeClassName : undefined
            }>
          <li className="hover-line">Upload</li>
        </NavLink>
        {/* //TODO change login to profile */}
        <NavLink to="/login" className={({ isActive }) =>
              isActive ? activeClassName : undefined
            }>
          <li className="hover-line">Profile</li>
        </NavLink>
        <NavLink to="/login" className={({ isActive }) =>
              isActive ? activeClassName : undefined
            }>
